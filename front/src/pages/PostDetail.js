      ...
      <PostHeader>
        ...
        <PostMeta>
          ...
          <PostStats>
            ...
            <span>{liked ? <AiFillHeart style={{ verticalAlign: 'middle', marginRight: '4px', color: '#e53935' }} /> : <AiOutlineHeart style={{ verticalAlign: 'middle', marginRight: '4px' }} />} {post.likes}</span>
